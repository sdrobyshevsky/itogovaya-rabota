...
Задание 3
Подключить дополнительный репозиторий MySQL. Установить любой пакет из этого репозитория. Впоследствии решил проблемы с установкой и запуском MySQL сервера:
